...
TeachingPlanInfoDlg.addSubmit = function() {
    ...
    //提交信息
    var ajax = new $ax(Feng.ctxPath + "/admin/lljxjh/add", function(data){
        Feng.success("添加成功!");
...
TeachingPlanInfoDlg.editSubmit = function() {
    ...
    //提交信息
    var ajax = new $ax(Feng.ctxPath + "/admin/lljxjh/update", function(data){
        Feng.success("修改成功!");
        window.parent.TeachingPlan.table.refresh();
        TeachingPlanInfoDlg.close();
    },function(data){
...
function importExcel(){
    ...
    Feng.startLoading();
    var options = {
        url : Feng.ctxPath + "/admin/lljxjh/import",
        type : "post",
        cache : false,
