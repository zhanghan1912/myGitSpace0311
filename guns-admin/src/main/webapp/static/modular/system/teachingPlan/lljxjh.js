...
TeachingPlan.openAddTeachingPlan = function () {
    var index = layer.open({
        ...
        fix: false, //不固定
        maxmin: true,
        content: Feng.ctxPath + '/admin/lljxjh_add'
    });
...
TeachingPlan.openTeachingPlanDetail = function () {
    if (this.check()) {
        var index = layer.open({
            ...
            fix: false, //不固定
            maxmin: true,
            content: Feng.ctxPath + '/admin/lljxjh_update/' + TeachingPlan.seItem.id
        });
        this.layerIndex = index;
    }
};
...
TeachingPlan.search = function () {
    ...
    var table = new BSTable(TeachingPlan.id, "/admin/lljxjh/list", defaultColunms);
...
TeachingPlan.openImportTeachingPlan = function () {
    var index = layer.open({
        ...
        fix: false, //不固定
        maxmin: true,
        content: Feng.ctxPath + '/admin/lljxjh_import'
    });
    this.layerIndex = index;
};
$(function () {
