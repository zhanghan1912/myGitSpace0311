...
public class ConstantFactory implements IConstantFactory {
    ...
    public static String OPRE_SUCCESSED = "SUCCESS";
    public static String OPRE_FAIL = "FAIL";
    /**
     * 根据用户id获取用户名称
     *
     * @author stylefeng
    ...
    public Integer getDeptId(String deptName) {
        ...
        Dept dept = deptMapper.selectOne(d);
        if (ToolUtil.isNotEmpty(dept) && ToolUtil.isNotEmpty(dept.getId())) {
            return dept.getId();
        }
        return -1;
    }
    ...
    @Override
    public String getDictNameByCode(String dictType,String code) {
        Dict temp = new Dict();
        temp.setCode(dictType);
        Dict dict = dictMapper.selectOne(temp);
        if (dict == null) {
            return "";
        } else {
    ...
    @Override
    public String getDictCodeByName(String dictType,String name) {
        Dict temp = new Dict();
        temp.setCode(dictType);
        Dict dict = dictMapper.selectOne(temp);
        if (dict == null) {
    ...
    @Override
    public List<Dict> findByDictType(String code) {
