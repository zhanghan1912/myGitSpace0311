...
DROP TABLE IF EXISTS `sys_teaching_plan`;
CREATE TABLE `sys_teaching_plan` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '计划活动编号',
  `plan_type` varchar(255) NOT NULL COMMENT '计划类型',
  ...
  `class_time` varchar(255) DEFAULT NULL COMMENT '时间',
  `class_place` varchar(255) DEFAULT NULL COMMENT '地点',
  `teachers` varchar(255) DEFAULT NULL COMMENT '任课老师',
  `class_name` varchar(255) DEFAULT NULL COMMENT '上课班级名称',
  `class_no` varchar(255) DEFAULT NULL COMMENT '上课班号',
  `class_target` varchar(255) DEFAULT NULL COMMENT '上课班级构成',
  `class_number` varchar(255) DEFAULT NULL COMMENT '上课人数',
  `class_order` varchar(255) DEFAULT NULL COMMENT '节次',
  `detail` varchar(255) DEFAULT NULL COMMENT '内容详情',
  `memo` varchar(255) DEFAULT NULL COMMENT '备注',
  `create_time` varchar(255) NOT NULL COMMENT '创建日期',
  `create_user_id` int(11) NOT NULL COMMENT '创建人id',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=69 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='计划活动表';

DROP TABLE IF EXISTS `sys_plan_visitor`;
CREATE TABLE `sys_plan_visitor` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '督导计划id',
  `plan_id` int(11) NOT NULL COMMENT '计划活动编号',
  `visite_flag` varchar(255) DEFAULT NULL COMMENT '参加督导标识',
  `visitor_id` int(11) DEFAULT NULL COMMENT '督导id',
  `visitor_name` varchar(255) DEFAULT NULL COMMENT '督导名称',
  `evaluate_score` varchar(4000) DEFAULT NULL COMMENT '评价详情',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=69 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='计划活动参与督导表';

DROP TABLE IF EXISTS `sys_cfg`;
CREATE TABLE `sys_cfg` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '设置id',
  `cfg_code` varchar(255) NOT NULL COMMENT '参数',
  `cfg_value` varchar(255) DEFAULT NULL COMMENT '内容',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=69 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='系统设置表';